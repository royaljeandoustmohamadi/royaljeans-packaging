...
یک سیستم مدیریت سفارشات کامل برای صنعت پوشاک با قابلیت مدیریت کالا، پیمانکاران، گزارشات پیشرفته و **سیستم مدیریت کاربران پیشرفته**.

---

## 🚀 ویژگی‌های جدید - سیستم کاربران

### 🔐 سیستم پروفایل کاربری پیشرفته
- **دو نوع نام**: نام اصلی (فقط ادمین) + نام مستعار (کاربر)
- **تصویر پروفایل**: آپلود و مدیریت عکس کاربر
- **اطلاعات شخصی**: شماره تماس، توضیحات
- **ایمیل غیرقابل تغییر**: امنیت بالا
- **تغییر رمز عبور**: با امنیت پیشرفته

### 👥 مدیریت کاربران (مخصوص ادمین)
- **لیست کاربران**: مشاهده همه کاربران با جزئیات کامل
- **فیلترهای پیشرفته**: جستجو، نقش، وضعیت
- **عملیات کامل**: مشاهده، ویرایش، حذف، فعال/غیرفعال
- **مدیریت نقش‌ها**: ادمین، مدیر، کاربر

### 🎨 UI Components مدرن
- **StatCard**: نمایش آمار با طراحی مدرن
- **DataTable**: جدول پیشرفته با جستجو، مرتب‌سازی، صفحه‌بندی
- **Notification System**: سیستم اعلان با طراحی جذاب
